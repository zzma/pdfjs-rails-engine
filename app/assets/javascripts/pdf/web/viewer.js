...
PDFJS.imageResourcesPath = '/assets/images/pdf/';
...
function updateViewarea() {
  ...
  if (document.getElementById('viewBookmark')) document.getElementById('viewBookmark').href = href;
  if (document.getElementById('secondaryViewBookmark')) document.getElementById('secondaryViewBookmark').href = href;
